...
neuron_id=100; % neuron channel id
neuron_rf=3; % neuron_rf x neuron_rf tiles will be visualized
...
opts= U_param(1,mid,ln,opts); % hard-coded learning rate and MRF energy parameters

% 3. run experiment
exp = experiment_init(mid,[], '', 'cnn', opts) ;
