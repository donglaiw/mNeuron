...
CAFFE_ROOT='/data/vision/billf/donglai-lib/VisionLib/Donglai/DeepL/caffe_action/matlab/caffe/';
MATCONVNET_ROOT='/data/vision/billf/donglai-lib/VisionLib/Donglai/DeepL/matconvnet_cpu/';
...
switch cnn_mode 
    ...
    case 'caffe'
        % matcaffe
        addpath([CAFFE_ROOT '/matlab/caffe']);
