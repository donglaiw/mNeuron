...
opts.fmask={{16,repmat(tmp_p5,[1,1,256])},{20,reshape(topic.W(:,TOPIC_ID)>0,[1,1,4096])}};
...
opts= U_param(2,mid,ln,opts); % hard-coded learning rate and MRF energy parameters
